...
use crate::catalog::schema::TableSchemaRef;
...
impl<R: Rng> SqlGenerator<'_, R> {
    ...
    pub(crate) fn gen_subquery(&mut self, one_column: bool) -> (Query, TableSchemaRef) {
        ...
        for i in 0..len {
            ...
            let field = TableField::new(&col_name, ty);
            fields.push(field);
        ...
        let schema = TableSchema::new_ref(fields);
    ...
    fn gen_table_func(&mut self) -> TableReference {
        ...
        match name {
            "numbers" | "numbers_mt" | "numbers_local" => {
                ...
                let schema = TableSchema::new_ref(vec![TableField::new(
                    "number",
            ...
            "generate_series" | "range" => {
                ...
                let mut gen_expr = |idx: i32| -> (DataType, Expr) {
                    match idx {
                        0 => {
                ...
                let table_name = Identifier::from_name(None, name.to_string());
                let schema = TableSchema::new_ref(vec![TableField::new(name, ty1)]);
                let table = Table::new(None, table_name.clone(), schema);
